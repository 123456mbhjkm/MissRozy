...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 15020988))
	API_HASH = os.environ.get("API_HASH", "15020988")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6717291823:AAEi0a9LsZOUm2roEqmAQcA2bbv_FavRJbU")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "pvtfiletolink_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001957767666))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1386927689"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://oyoyoyo158:RGmfLfu4Ttt9NSKW@cluster0.ajg27hw.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001561806287")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002104640541")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "1234567890").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('MoviesMinerHD','-100'))
